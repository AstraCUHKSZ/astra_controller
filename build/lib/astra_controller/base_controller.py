...
class BaseController:
    ...
    async def odrive_can_thread(self, node_id):
        ...
        if not self.use_legacy_v0_5_1:
            # Set gains
            drv.set_pos_gain(3.0) # not working for v0.5.1 # use odrivetool to tune pid 3

            # Set gains
            drv.set_vel_gains(0.05, 0) # not working for v0.5.1 # use odrivetool to tune pid 0.04
